...
export default function SideMenu({ userRole }: Props) {
  ...
  function toggleUserManagementMenu(): void {
    ...
    if (userManagementMenu) {
      (userManagementMenu as HTMLElement).style.display =
        isUserManagementMenuOpen ? "block" : "none";
    }
  }
  ...
  function toggleScheduleManagementMenu(): void {
    ...
    const scheduleManagementMenu = document.querySelector(
      ".schedule-managment-menu"
    );
    if (scheduleManagementMenu) {
      (scheduleManagementMenu as HTMLElement).style.display =
        isScheduleManagementMenuOpen ? "block" : "none";
    }
  }
  ...
  function toggleProjectManagementMenu(): void {
    ...
    const ProjectManagementMenu = document.querySelector(
      ".project-managment-menu"
    );
    if (ProjectManagementMenu) {
      (ProjectManagementMenu as HTMLElement).style.display =
        isProjectManagementMenuOpen ? "block" : "none";
    }
  }
  ...
  function toggleTeacherScheduleManagementMenu(): void {
    ...
    const TeacherScheduleManagementMenu = document.querySelector(
      ".schedule-managment-menu"
    );
    if (TeacherScheduleManagementMenu) {
      (TeacherScheduleManagementMenu as HTMLElement).style.display =
        isTeacherScheduleManagementMenuOpen ? "block" : "none";
    }
  }
          ...
          <>
            <div className="Project-managment py-3 px-2 myBorder-bottom">
              ...
              >
                ...
                <i
                  className={`bi ${isProjectManagementMenuOpen ? "bi-chevron-up" : "bi-chevron-down"}`}
                ></i>
              </div>
            ...
            <div className="Schedule-managment py-3 px-2">
              ...
              >
                ...
                <i
                  className={`bi ${isTeacherScheduleManagementMenuOpen ? "bi-chevron-up" : "bi-chevron-down"}`}
                ></i>
              </div>
        ...
        <>
          ...
          <Nav className="flex-column">
            <div className="dashboard py-3 px-2 myBorder-bottom">
              ...
              <Link
                to="/dashboard/admin/pfe-proposals"
                className="aside-option"
                id="1"
            ...
            <>
              <div className="user-managment py-3 px-2 myBorder-bottom">
                ...
                >
                  ...
                  <i
                    className={`bi ${isUserManagementMenuOpen ? "bi-chevron-up" : "bi-chevron-down"}`}
                  ></i>
                </div>
              ...
              <div className="topics-managment  py-3 px-2">
                ...
                >
                  <h6 className="text-left">Schedule</h6>
                  <i
                    className={`bi ${isScheduleManagementMenuOpen ? "bi-chevron-up" : "bi-chevron-down"}`}
                  ></i>
                </div>
                <div className="schedule-managment-menu">
                  <Link
